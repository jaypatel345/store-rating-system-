...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?])/, { message: 'Password must contain at least one special character' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsEnum)(user_entity_1.UserRole, { message: 'Role must be ADMIN, USER, or STORE_OWNER' }),
    __metadata("design:type", String)
